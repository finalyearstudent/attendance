...
public interface AttendanceMapper {
	...
	public void insertAttendance(@Param("attendanceDO") AttendanceDO attendanceDO);
	...
	@Update("update t_attendance set c_status = #{attendanceDO.status}, c_task = #{attendanceDO.task}," +
			...
			"and d_date = #{date}")
	public void updateAttendance(@Param("attendanceDO") AttendanceDO attendanceDO, @Param("date")String date);
